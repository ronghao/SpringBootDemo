...
////这里写入需要生成校验码的字符串
////        byte[] sbuf = CRC16M.getSendBuf("07640027000C01000100B4F3BCAAB4F3C0FB0000");
////        String ss = CRC16M.getBufHexStr(sbuf);//将字节转成字符串
//////输出带有校验码的字符串
////        System.out.println(ss);
//        String result =getResultByHexStr("036400220009B4F3BCAAB4F3C0FB020000");
//        System.out.println(result);
//    }


    public static String getResultByHexStr(String str) {
        byte[] sbuf = CRC16M.getSendBuf(str);
        String strAll = CRC16M.getBufHexStr(sbuf);
        String result = strAll.substring(strAll.length() - 4);
        return result;
    }
